...
public class ModifyCustomerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.modify_customer, container, false);
        ...
        submit_button= view.findViewById(R.id.modifyCustomerSubmitButton2);
